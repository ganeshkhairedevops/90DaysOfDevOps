...
![task 1](https://github.com/ganeshkhairedevops/90DaysOfDevOps/blob/82db5be8fb931467f39865850e0c7a69d0de1dad/2026/day-80/images/task%201.JPG)
...
![task 2](https://github.com/ganeshkhairedevops/90DaysOfDevOps/blob/82db5be8fb931467f39865850e0c7a69d0de1dad/2026/day-80/images/task%202.JPG)
...
```
![task 3](https://github.com/ganeshkhairedevops/90DaysOfDevOps/blob/82db5be8fb931467f39865850e0c7a69d0de1dad/2026/day-80/images/task%203.JPG)
...
![task 3.1](https://github.com/ganeshkhairedevops/90DaysOfDevOps/blob/82db5be8fb931467f39865850e0c7a69d0de1dad/2026/day-80/images/task%203.1.JPG)
...
helm repo index chart-repo/ --url https://ganeshkhairedevops.github.io/helm-charts
cat chart-repo/index.yaml
```

![task 3.2](https://github.com/ganeshkhairedevops/90DaysOfDevOps/blob/82db5be8fb931467f39865850e0c7a69d0de1dad/2026/day-80/images/task%203.2.JPG)
...
- **Reusability** — one chart can deploy to dev/staging/prod using different values.yaml
- **Less YAML duplication** — avoids copying manifests across environments
- **Parameterization** — easy overrides for replicas, image tags, resources, etc.
- **Scalability** — easier to manage many apps/clusters
- **Dependency management** — can bundle things like Redis/Postgres as chart dependencies
- **Conditional resources** — enable/disable ingress, HPA, monitoring, etc.
- **Versioned packaging** — better release tracking and upgrades
- **Better ecosystem support** — many Kubernetes tools already ship official Helm charts

Raw manifests are simpler and more transparent, but Helm becomes much easier to maintain at scale.
...
![task 6](https://github.com/ganeshkhairedevops/90DaysOfDevOps/blob/82db5be8fb931467f39865850e0c7a69d0de1dad/2026/day-80/images/task%206.JPG)
...
![task 6.1](https://github.com/ganeshkhairedevops/90DaysOfDevOps/blob/82db5be8fb931467f39865850e0c7a69d0de1dad/2026/day-80/images/task%206.1.JPG)
